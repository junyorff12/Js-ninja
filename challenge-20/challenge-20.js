(function(window, document){
    ...
    */
    let username = window.prompt('Qual seu nome?') || 'Desconhecido';
    ...
    */
    let email = window.prompt('informe se email!');
    ...
    */
    ...
    Alguns e-mails válidos que podem ser usados para testarkey: "value", 
