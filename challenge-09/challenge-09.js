(function(){/*
    ...
    */
    let sub = calculator(4,3);
    let div = calculator(5,3);
    let multi = calculator(3,1);
    let mod = calculator(11,3);
    ...
    chamada.
    */
    console.log( 'O resultado da subtração é:', sub( (x,y) => x - y) );
    // ?

    console.log( 'O resultado da multiplicação é:', multi( (x,y) => x * y) );
    // ?

    console.log( 'O resultado da divisão é:', div( (x, y) => x / y).toFixed(2) );
    // ?
