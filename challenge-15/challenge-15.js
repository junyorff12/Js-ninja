(function(){
  ...
  */
  ...
  let joao = new Person( 'João', 'Pedro', 22);
  let lucas = new Person( 'Lucas', 'Evangelista', 22);
  let junyor = new Person( 'Jr', 'FF12', 31);
  ...
  */
  ...
  console.log( junyor.getFullName());
  ...
  */
  ...
  console.log( junyor.getFullName() + ' tem ' + junyor.getAge() + ' anos');
  ...
  */
  ...
  console.log( junyor.getFullName() + ' agora tem ' + junyor.addAge(1).getAge() + ' anos');
