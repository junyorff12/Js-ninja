(function(){
	...
	*/
	...
	console.log( text.replace(/Manuel Marques de Sousa/, 'Antonio Antao da Silva'));
	...
	*/
	...
	console.log( text.replace(/brasileiro/, 'Piauiense'));
	...
	*/
	...
	console.log( text.replace(/A|a/g, 4)); // ou [Aa] ou a gi
	...
	*/
	...
	let getMonthNumber = function getMonthNumber( monthName ) {
        let month = {
        	janeiro: '01',
        	fevereiro: '02',
        	março: '03',
